...
import com.springinaction.tacoman.repository.TacoRepo;
...
@RestController
@RequestMapping(path = "/api/tacos", //Handles requests for /api/tacos
                produces = "application/json")
@CrossOrigin(origins = "http://tacocloud:8181" //Allows cross-origin requests
            )
public class TacoController {
    ...
    public Iterable<Taco> recentTacos() {
        ...
        return tacoRepo.findAll((Pageable) page).getContent();
